...
@section('content')
    <div class="container">
        ...
        @else
            <a href="{{ url('cactus/create')}}" class="btn btn-success">Agregar planta</a><br><br>
        ...
        @foreach ($plantas as $planta)
            ...
            <div class="clienimg" >
                ...
                @else
                    ...
                    <a href="{{ url('/cactus/'.$planta->id.'/edit') }}" class="btn btn-warning">
                    ...
                    <form action="{{ url('/cactus/'.$planta->id) }}" style="display:inline" method="post">
                        @csrf
